...
<div>
    <div>
        ...
        <tbody>
            <tr>
                ...
                <td>+</td>
                <td>
                    <input type="number" v-model="armorClass.magicBonus" v-on:click="initValues(armorClass)" v-on:keyup="updateCA(armorClass)" />
                </td>
                <td>=</td>
    ...
    <!--<div>
      <div>
        <label>Armure normale</label>
        <input type="checkbox"/>
      </div>
      <div>
        <label>Armure du mage</label>
        <input type="checkbox"/>
      </div>
    </div> -->
    <div>
    ...
    <div>
        ...
        <ul>
            <li v-for="(vulnerability,index) in armorClass.vulnerabilities" :key="index">
                {{vulnerability}}
                <button v-on:click="deleteElement(vulnerability, armorClass.vulnerabilities)">-</button>
            </li>
        </ul>
        <div>
