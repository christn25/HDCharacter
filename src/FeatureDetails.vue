...
<tr>
    <td>{{feature.name}}</td>
    <td>
        <input type="number" v-model="feature.value" v-on:keyup="updateData(details, stats, feature, pvTracking, fightModifiers, ddjs, armorClass)" v-on:click="initValues(stats, feature, pvTracking)" min="0" />
    </td>
