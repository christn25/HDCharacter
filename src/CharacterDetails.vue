...
<div>
    ...
    <div>
        <input type="number" v-model="details.level" placeholder="Niveau" min="1" v-on:keyup="updateMasteryValue(details, stats, pvTracking, fightModifiers)" v-on:click="initLevel(details)" />
    </div>
    <div>
        <select id="char-breed" v-model="details.breed" v-on:change="changeBreed(details.breed, stats)">
    ...
    <div>
        <select id="char-class" v-model="details.class" v-on:change="changeClass(details, stats, pvTracking, ddjs, fightModifiers)">
